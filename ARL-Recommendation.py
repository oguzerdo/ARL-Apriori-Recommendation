"""
############################################
# Özelleştirilmiş Ürün Önerileri Geliştirme
############################################
...
Buradaki amaç sadece tüm segment gruplarını bir alıp, ülke bazında seyrekleşebilecek ürün tavsiyeleri için diğer ülkelerden de bilgi almak.
...
cltv_p.head()
# Alman müşterilerin IDlerinin alınması.
...
# Her bir segment için 1 tane ürün ekleme
